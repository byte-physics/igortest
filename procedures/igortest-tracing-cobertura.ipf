...
static Function/S GetProcedureReport(string procName, string procPath, variable procIndex, WAVE totals, WAVE marker, WAVE/T sources)
	...
	variable i, funcCount, funcEnd, epochTime
	...
	sprintf line, "<coverage line-rate=\"%f\" branch-rate=\"%f\" lines-covered=\"%d\" lines-valid=\"%d\" branches-covered=\"%d\" branches-valid=\"%d\" complexity=\"%s\" version=\"0.0\" timestamp=\"%d000\">\n", \
		metrics.lineRate, metrics.branchRate, metrics.lineCovered, metrics.lineValid, metrics.branchCovered, metrics.branchValid, INVALID_COMPLEXITY, epochTime
	report += line
	...
	report += "\t<packages>\n"
	sprintf line, "\t\t<package name=\"%s\" line-rate=\"%f\" branch-rate=\"%f\" complexity=\"%s\">\n", FilePathToXml(info.packageName), metrics.lineRate, metrics.branchRate, INVALID_COMPLEXITY
	report += line

	report += "\t\t\t<classes>\n"
	sprintf line, "\t\t\t\t<class name=\"%s\" filename=\"%s\" line-rate=\"%f\" branch-rate=\"%f\" complexity=\"%s\">\n", IUTF_Utils_Xml#ToXmlToken(info.className), FilePathToXml(info.classFileName), metrics.lineRate, metrics.branchRate, INVALID_COMPLEXITY
	report += line
