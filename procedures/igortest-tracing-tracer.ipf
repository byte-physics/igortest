...
///        The function IUTF_Tracing#AnalyzeTracingResult() evaluates the collected information from the shared thread storage
...
threadsafe Function Z_(variable procNum, variable lineNum, [variable c, variable l])
	...
	if(V_flag)
		...
		if(V_flag)
			IUTF_Reporting#IUTF_PrintStatusMessage("No gathered tracing data found for code coverage analysis.")
			return c
		endif
