...
static Function TestUTF()
	...
	Ensure(UTF_Checks#AreVariablesClose( 0,   0.5, 1,    STRONG_CLOSENESS))
	Ensure(UTF_Checks#AreVariablesClose( 0,   0.5, 1,    WEAK_CLOSENESS))
	Ensure(UTF_Checks#AreVariablesClose( 0.5, 0,   1,    STRONG_CLOSENESS))
	Ensure(UTF_Checks#AreVariablesClose( 0.5, 0,   1,    WEAK_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0,   0.5, 0.25, STRONG_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0,   0.5, 0.25, WEAK_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0.5, 0,   0.25, STRONG_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0.5, 0,   0.25, WEAK_CLOSENESS))

	Ensure(!UTF_Checks#AreVariablesClose(NaN, 0, DEFAULT_TOLERANCE, WEAK_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(NaN, 0, DEFAULT_TOLERANCE, STRONG_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0, NaN, DEFAULT_TOLERANCE, WEAK_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0, NaN, DEFAULT_TOLERANCE, STRONG_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(Inf, 0, DEFAULT_TOLERANCE, WEAK_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(Inf, 0, DEFAULT_TOLERANCE, STRONG_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0, Inf, DEFAULT_TOLERANCE, WEAK_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0, Inf, DEFAULT_TOLERANCE, STRONG_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(-Inf, 0, DEFAULT_TOLERANCE, WEAK_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(-Inf, 0, DEFAULT_TOLERANCE, STRONG_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0, -Inf, DEFAULT_TOLERANCE, WEAK_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0, -Inf, DEFAULT_TOLERANCE, STRONG_CLOSENESS))

	Ensure(UTF_Checks#AreVariablesClose(0, 0, 0, WEAK_CLOSENESS))
	Ensure(UTF_Checks#AreVariablesClose(0, 0, 0, STRONG_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(0, 1e-308, 0, WEAK_CLOSENESS))
	Ensure(!UTF_Checks#AreVariablesClose(1e-308, 0, 0, STRONG_CLOSENESS))

	Ensure(UTF_Checks#AreVariablesClose(0, 1, 1, WEAK_CLOSENESS))
	Ensure(UTF_Checks#AreVariablesClose(0, 1, 1, STRONG_CLOSENESS))
	Ensure(UTF_Checks#AreVariablesClose(1, 0, 1, WEAK_CLOSENESS))
	Ensure(UTF_Checks#AreVariablesClose(1, 0, 1, STRONG_CLOSENESS))
	// @}
...
static Function TestIUTFSetup()
	...
	Ensure(UTF_Basics#CreateTestRunSetup(thisProcName, ".*", 1, tmpStr, 0, IUTF_DEBUG_DISABLE) == 0)
